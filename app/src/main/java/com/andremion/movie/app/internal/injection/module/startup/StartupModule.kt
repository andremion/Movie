...
package com.andremion.movie.app.internal.injection.module.startup

import android.arch.lifecycle.ViewModel
import android.arch.lifecycle.ViewModelProvider
import com.andremion.movie.app.startup.StartupViewModel
            ...
            override fun <T : ViewModel?> create(modelClass: Class<T>): T {
                return when {
                    modelClass.isAssignableFrom(StartupViewModel::class.java) ->
                        StartupViewModel(appSchedulers, movieRepository) as T
