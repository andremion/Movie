...
package com.andremion.movie.app.internal.injection.module.movie

import android.arch.lifecycle.ViewModel
import android.arch.lifecycle.ViewModelProvider
import com.andremion.movie.app.internal.injection.scope.HomeScope
import com.andremion.movie.app.movie.detail.MovieDetailViewModel
                ...
                override fun <T : ViewModel?> create(modelClass: Class<T>): T {
                    return when {
                        modelClass.isAssignableFrom(MovieDetailViewModel::class.java) ->
                            MovieDetailViewModel(appSchedulers, movieRepository) as T
